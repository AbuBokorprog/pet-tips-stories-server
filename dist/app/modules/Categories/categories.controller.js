...
const createCategory = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const data = await categories_service_1.categoryService.createCategory(req.file, req.body);
...
const retrieveAllCategory = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const data = await categories_service_1.categoryService.retrieveAllCategory();
    (0, successRespon_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.CREATED,
...
const updateCategory = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { id } = req.params;
    const data = await categories_service_1.categoryService.updateCategory(req?.file, id, req.body);
    (0, successRespon_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.CREATED,
...
const deleteCategory = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { id } = req.params;
    const data = await categories_service_1.categoryService.deleteCategory(id);
    (0, successRespon_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.CREATED,
